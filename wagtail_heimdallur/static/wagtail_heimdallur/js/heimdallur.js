...
var WagtailHeimdallur = (() => {
  ...
  __export(src_exports, {
    ...
    ProofreadButton: () => ProofreadButton,
    TranslateButton: () => TranslateButton,
    TranslationPreview: () => TranslationPreview,
    applyAnnotationCorrection: () => applyAnnotationCorrection,
    applyAnnotationCorrectionToRaw: () => applyAnnotationCorrectionToRaw,
    applyCorrectedBlockText: () => applyCorrectedBlockText,
    fetchLanguagePairs: () => fetchLanguagePairs,
    getProofreadableBlocks: () => getProofreadableBlocks,
    initRichTextProofreader: () => initRichTextProofreader,
  ...
  function proofreadText(text, language) {
    return postJson("/api/heimdallur/proofread/", {
      text,
      language
    });
  }
  async function translateText(text, sourceLanguage, targetLanguage) {
    const data = await postJson("/api/heimdallur/translate/", {
      text,
  ...
  async function fetchLanguagePairs() {
    ...
    return data.translation.language_pairs;
  }
  ...
  // src/proofread/richTextProofreader.ts
  var INITIALIZED_ATTRIBUTE = "data-heimdallur-proofread";
  function initRichTextProofreader(root = document) {
    const fields = Array.from(
      root.querySelectorAll("input[data-draftail-input]")
    );
  ...
  function getProofreadableBlocks(rawJson) {
  ...
  function applyCorrectedBlockText(rawJson, blockKey, correctedText) {
    const content = parseRawContent(rawJson);
  ...
  function applyAnnotationCorrectionToRaw(rawJson, blockKey, annotation) {
    const content = parseRawContent(rawJson);
    const blocks = content.blocks || [];
    const block = blocks.find((candidate) => candidate.key === blockKey);
    if (!block) {
  ...
  function mountProofreadPanel(field) {
    ...
    button.addEventListener("click", async () => {
      ...
      try {
        ...
        status.textContent = error instanceof Error ? error.message : "Proofreading failed.";
      } finally {
  ...
  async function proofreadField(field) {
    ...
    return results.filter(
      ({ result }) => result.annotations.length > 0 || result.corrected_text !== result.original_text
    );
  }
  function renderProofreadingResults(field, container, status, results) {
    if (!results.length) {
      status.textContent = "No proofreading suggestions.";
      return;
    }
    status.textContent = `${results.length} text block${results.length === 1 ? "" : "s"} with suggestions.`;
    results.forEach(({ block, result }) => {
      ...
      meta.textContent = `${result.annotations.length} suggestion${result.annotations.length === 1 ? "" : "s"}`;
  ...
  function parseRawContent(rawJson) {
    try {
  ...
  function applyAnnotationToText(text, annotation) {
  ...
  function adjustRanges(ranges, replacementEnd, delta) {
  ...
  function getLanguage(field) {
    const closestLanguage = field.closest("[lang]")?.lang;
    return (closestLanguage || document.documentElement.lang || "is").split("-")[0] || "is";
  }

  // src/proofread/ProofreadButton.tsx
  var import_react = __toESM(require_react(), 1);
  var import_jsx_runtime = __toESM(require_jsx_runtime(), 1);
  function ProofreadButton({
    text,
    language,
    onResult,
    onError
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
      "button",
      {
        ...
        disabled: isLoading,
        onClick: handleClick,
        children: isLoading ? "Proofreading" : "Proofread"
      }
    );
  }

  // src/proofread/AnnotationDecorator.tsx
  ...
  // src/proofread/AnnotationPopover.tsx
  ...
  function AnnotationPopover({
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("div", { className: "heimdallur-popover", role: "dialog", "aria-label": "Proofreading suggestion", children: [
      /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("dl", { children: [
        /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("dt", { children: "Original" }),
        /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("dd", { children: annotation.orig_string }),
        /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("dt", { children: "Suggestion" }),
        /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("dd", { children: annotation.changed_string }),
        /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("dt", { children: "Type" }),
        /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("dd", { children: annotation.change_type })
      ] }),
      /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("div", { className: "heimdallur-actions", children: [
        /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("button", { type: "button", onClick: () => onAccept(annotation), children: "Accept" }),
        /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("button", { type: "button", onClick: () => onDismiss(annotation), children: "Dismiss" })
      ] })
    ] });
  }

  // src/translate/TranslateButton.tsx
  var import_react2 = __toESM(require_react(), 1);
  var import_jsx_runtime4 = __toESM(require_jsx_runtime(), 1);
  function TranslateButton({ onOpen }) {
  ...
  // src/translate/LanguagePairSelector.tsx
  var import_react3 = __toESM(require_react(), 1);
  var import_jsx_runtime5 = __toESM(require_jsx_runtime(), 1);
  function LanguagePairSelector({ onSelect, onError }) {
    const [pairs, setPairs] = (0, import_react3.useState)([]);
    const [selected, setSelected] = (0, import_react3.useState)("");
    (0, import_react3.useEffect)(() => {
      let isActive = true;
      fetchLanguagePairs().then((loadedPairs) => {
        if (!isActive) {
          return;
        }
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)("div", { className: "heimdallur-language-selector", children: [
      /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(
        "select",
        {
          ...
          children: pairs.map((pair) => /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)("option", { value: pairKey(pair), children: [
  ...
  // src/translate/TranslationPreview.tsx
  ...
  function TranslationPreview({
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)("section", { className: "heimdallur-translation-preview", "aria-label": "Translation preview", children: [
      /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("p", { children: translatedText }),
      /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)("div", { className: "heimdallur-actions", children: [
        /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("button", { type: "button", onClick: () => onAccept(translatedText), children: "Accept" }),
        /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("button", { type: "button", onClick: onCancel, children: "Cancel" })
      ] })
    ] });
  }
